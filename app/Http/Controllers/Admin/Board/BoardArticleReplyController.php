...
class BoardArticleReplyController extends Controller
{
    public function index($id = null, $article = null)
    {
        ...
        $boardarticles = BoardArticle::where(function ($query) {
                $query->where('started_at', '<', Carbon::now()->timestamp)
                    ->orWhere('started_at', null);
            })
            ->get();
    ...
    public function create($id)
    {
        ...
        return view('manage.pages.board.article.create', compact('board'));
    }
    ...
    public function show($id, $article)
    {
        ...
        return view('manage.pages.board.article.show', compact('site', 'boardarticle', 'boardarticleparameter', 'boardarticleperiod'));
    }
    ...
    public function edit($id, $article)
    {
        ...
        return view('manage.pages.board.article.edit', compact('site', 'boardarticle', 'boardarticleparameter', 'boardarticleperiod'));
    }
