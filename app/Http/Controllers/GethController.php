...
class GethController extends Controller
{
    protected static $_defaultOptions = [
        'version' => '2.0',
        'host' => "rinkeby.infura.io/v3/b5e57419bbfc480b88858b8fd0d701b0",
        'port' => 443,
        'assoc' => true,
        'connect_timeout' => 2,
        'timeout' => 10
    ...
    public function __construct($options = null)
    {
        ...
        $eth_net = env('ETH_NETWORK');
        $infura_id = env('RINKEBY_PROJECT_ID');
        $this->_address = "https://{$eth_net}.infura.io/v3/{$infura_id}";
     ...
     * @throws Exception
     */
    function eth_subscribe($hash = "newHeads")
    {
        return $this->__call(__FUNCTION__, func_get_args());
    }
    ...
    function personal_unlockAccount($address, $passphase)
    {
        return $this->__call(__FUNCTION__, func_get_args());
    }
}
